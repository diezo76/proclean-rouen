...
export const serviceSections: Record<string, ContentBlock[]> = {
  ...
  'nettoyage-camion-rouen': [
    ...
    },
    {
      ...
      headingLevel: 3,
      paragraphs: [
        'Transport frigorifique, matières sensibles, transport médical — ces cabines exigent des protocoles stricts. Pas de marge d\'erreur. Un camion qui transporte des denrées alimentaires ne peut pas sentir le désinfectant classique. Un véhicule sanitaire doit être irréprochable à chaque audit.',
    ...
    },
    {
      ...
      headingLevel: 3,
      paragraphs: [
        'On commence par une décontamination complète avec des produits agréés contact alimentaire — pas de résidu, pas d\'odeur. Ensuite, nettoyage des équipements de réfrigération intégrés à la cabine sans toucher aux systèmes de contrôle de température. L\'assainissement des circuits d\'air suit, puis un contrôle d\'hygrométrie clôture l\'intervention. Chaque étape est documentée dans un rapport de traçabilité conforme aux exigences HACCP. On cale l\'intervention pour ne jamais rompre votre chaîne du froid.',
      ],
    },
    {
    ...
    },
    {
      ...
      headingLevel: 3,
      paragraphs: [
        'Les véhicules de transport médical et pharmaceutique suivent un protocole à part. Désinfection hospitalière homologuée, nébulisation de stérilisation, traçabilité complète pour vos audits sanitaires. Nos techniciens sont formés aux risques biologiques. Après chaque intervention, vous recevez un certificat de désinfection — indispensable pour la conformité réglementaire de votre flotte.',
      ],
    },
  ],
  ...
  'nettoyage-toiture-rouen': [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Communes de l\'agglomération — on se déplace aussi chez vous :',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Phase Organisation : on gère la logistique. Déclaration de travaux si nécessaire, information du voisinage, respect du règlement de copropriété. On protège vos espaces extérieurs — jardin, terrasse, véhicules — avant de commencer. Vous n\'avez rien à faire.',
        'Phase Préparation : sécurisation complète. Balisage réglementaire, protection de vos biens, vérification des harnais et équipements de sécurité. On prépare les solutions adaptées à vos matériaux — un produit pour l\'ardoise, un autre pour la tuile, un troisième pour la pierre.',
        'Phase Technique : nettoyage basse pression, <strong>démoussage complet</strong>, traitement hydrofuge et fongicide. On vérifie en continu : test d\'écoulement des gouttières, contrôle de l\'étanchéité, validation visuelle de chaque versant. Si un problème apparaît — tuile fissurée, joint défaillant — on vous le signale immédiatement.',
        'Phase Validation : inspection finale de toutes les surfaces traitées. Retouches si nécessaire. On nettoie les abords, on évacue les déchets de mousse et de végétation, on remet votre jardin et vos allées en état. Vous validez le résultat avec nous sur place.',
        'Phase Suivi : on vous donne des conseils d\'entretien concrets pour prolonger la durée du traitement. Garantie satisfaction sur toutes nos prestations. Et on planifie le prochain passage — dans 3 à 5 ans selon votre exposition — pour ne pas laisser la mousse reprendre le dessus.',
      ],
    },
    {
      heading: '❓ Foire aux Questions : Expertise ProClean à Votre Service',
      ...
      paragraphs: [
        ...
        'Intervenez-vous après une tempête ? Oui, sous 48h. Branches sur le toit, gouttières arrachées, tuiles déplacées — on sécurise d\'abord, on répare ensuite. Priorité aux situations dangereuses et aux ERP. Appelez le 07.49.13.06.83.',
      ],
    },
    {
      heading: '💳 Politique Tarifaire Transparente et Solutions de Paiement',
      ...
      paragraphs: [
        ...
        'Moyens de paiement acceptés',
        'Conditions claires. Devis gratuit valable 30 jours. Acompte de 30% pour les gros chantiers, solde à réception des travaux. Facilités de paiement possibles sur devis pour les interventions importantes.',
      ],
      listItems: [
