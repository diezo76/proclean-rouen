  ...
  'nettoyage-camion-rouen': [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Les flottes de transport longue distance utilisant l\'A13 comme axe principal nécessitent des protocoles adaptés aux longs trajets et aux couchettes intégrées, tandis que les véhicules de transport régional desservant la Normandie requièrent des nettoyages résistants aux variations climatiques et aux terrains ruraux.',
      ],
    },
    {
    ...
    },
    {
      ...
      headingLevel: 3,
      paragraphs: [
        'Les véhicules de distribution urbaine dans la métropole rouennaise (centre historique, zones commerciales, quartiers résidentiels) subissent des contraintes spécifiques : multiples arrêts quotidiens, manipulation de marchandises diverses, exposition aux pollutions urbaines.',
  ...
  'nettoyage-tapis-rouen': [
    ...
    },
    {
      ...
      listItems: [
        ...
        'Traitement anti-<strong>acariens</strong> renforcé pour allergies et sensibilités',
